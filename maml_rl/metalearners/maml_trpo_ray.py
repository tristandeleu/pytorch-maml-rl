...
class MAMLTRPORAY(GradientBasedMetaLearner):
    ...
    def __init__(self,
                 ...
                 first_order=False,
                 device='cpu'):
        super(MAMLTRPORAY, self).__init__(policy, device=device)
    ...
    def surrogate_loss(self, train_episodes, valid_episodes, old_pi=None):
