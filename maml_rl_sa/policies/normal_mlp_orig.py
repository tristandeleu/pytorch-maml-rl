...
class NormalMLPPolicy(Policy):
    ...
    def forward(self, input, params=None):
        ...
        output = input.float() # Michelle changed on 3/18/19
        for i in range(1, self.num_layers):
            # print('weight = ',params['layer{0}.weight'.format(i)])
            # print('bias = ',params['layer{0}.bias'.format(i)])
